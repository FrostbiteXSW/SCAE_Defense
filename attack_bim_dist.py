...
if __name__ == '__main__':
	...
	while remain > 0:
		...
		output_stu = attacker_stu(images, labels, num_iter=num_iter, nan_if_fail=True, verbose=True)
		output_tch = attacker_tch(images, labels, num_iter=num_iter, nan_if_fail=True, verbose=True)
